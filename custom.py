...
class MultiHDF5Dataset(Dataset):
    def __init__(self, 
                 # TUPLA DE LA RESOLUCION DE ENTRADA
                 size, 
                 # ARCHIVO DE TEXTO CON LA DIRECCION DE LOS ARCHIVOS H5, UNA DIRECCION POR FILA, SIMPLE SIN NADA MAS
                 hdf5_paths_file, 
                 # AUGMENTATION
                 aug='resize_center', 
                 # VALORES PARA CORTAR LA IMAGEN, PARTE DE HACER CROPPING COMO AUGMENTATION
                 scale_min=0.15, 
                 scale_max=0.5
                 ):
        self.size = size
